...
<script lang="ts">
  ...
  let displayDifficulty: true; // set via settings?
  ...
  $: {
    ...
    let dif = encounterDifficulty(playerLevels, monstersXp);
    let progress =
...
<div class="obsidian-initiative-tracker">
  ...
  />
  <div class="difficulty-bar-container" aria-label={formatDifficultyReport(dr)}>
    <span>Easy</span>
    <span
      ><meter
